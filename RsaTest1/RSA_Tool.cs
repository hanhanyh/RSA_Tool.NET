...
namespace RsaTest1
{
    ...
    public class RSATool
    {
        ...
        public string SignByPrivateKey(string data, string key)
        {
            ...
            ISigner normalSig = SignerUtilities.GetSigner("SHA256WithRSA");//SHA1WithRSA
        ...
        public bool ValidationPublicKey(string plainData, string sign, string key)
        {
            ...
            byte[] plainBytes = Encoding.UTF8.GetBytes(plainData);//UTF8


            ISigner verifier = SignerUtilities.GetSigner("SHA256WithRSA");//SHA1WithRSA
